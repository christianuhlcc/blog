...
date: 2023-01-08T22:35:00+01:00
draft: false
...
I found that from a pure resiliency perspective though, it helped a lot to ditch the original server-side templating for a solid internal API that gets consumed by a Frontend Application. It doesn't matter much if it's a SPA Application or more classical websites with injected Javascript. It probably doesn't even matter if it's a separate Frontend at all, as long as you can untangle the frontend from the backend, and get some solid modularization in there. 
